...
'''
It contains Staffmember business logics
'''


class StaffmemberService(BaseService):



    def search(self, params):
        pageNo = (params['pageNo'] - 1) * self.pageSize
        sql = "select * from sos_staffmember where 1=1"
        sql += " limit %s,%s"
        ...
        columnName = ('id', 'fullName', 'joiningDate', 'division', 'previousEmployer','did')
        res = {
            "data": [],
            "MaxId": 1,
        }
